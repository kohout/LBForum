...
topic_patterns = patterns(
    ...
    url('^new/(?P<forum_id>\d+)/$', views.new_post,
        name='lbforum_new_topic'),
)

post_patterns = patterns(
    '',
    url('^(?P<post_id>\d+)/$', views.post,
        name='lbforum_post'),
    url('^(?P<post_id>\d+)/edit/$', views.edit_post,
...
urlpatterns = patterns(
    '',
    url(r'^forum/$', views.index, name='lbforum_index'),
    ...
    url('^user/(?P<username>[ \w@\d.-]+)/topics/$', views.user_topics,
        name='lbforum_user_topics'),
    url('^user/(?P<username>[ \w@\d.-]+)/posts/$', views.user_posts,
